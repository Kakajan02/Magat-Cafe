...
function Items() {
  var _useAppContext = (0,_Context__WEBPACK_IMPORTED_MODULE_5__.useAppContext)(),
    ...
    wrapperRef = (0,react__WEBPACK_IMPORTED_MODULE_4__.useRef)();
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(function () {
    ...
    function handleScroll() {
      ...
      sections.forEach(function (current) {
        ...
        if (scrollY + 80 > sectionTop && scrollY + 80 <= sectionTop + sectionHeight) {
          oldId && document.querySelector("#_" + oldId).classList.remove(_css_module_css__WEBPACK_IMPORTED_MODULE_2__["default"]["active"]);
          var item = document.querySelector("#_" + sectionId);
          item.classList.add(_css_module_css__WEBPACK_IMPORTED_MODULE_2__["default"]["active"]);
          oldId = sectionId;
          item.scrollIntoView();
        }
      });
