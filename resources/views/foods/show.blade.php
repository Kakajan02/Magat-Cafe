    ...
    <div class="nk-data data-list">
      <div class="data-item">
        <div class="data-col">
          ...
          <span class="data-value"><img src="{{ $food->arrImage() }}" alt="{{ $food->id }}" style="height: 60px"></span>
        </div>
        <div class="data-col data-col-end"><a href="{{ $food->arrImage() }}" class="data-more" target="_blank"><em class="icon ni ni-forward-ios"></em></a></div>
      </div>
      <div class="data-item">
        <div class="data-col">
